...
post_list = [
  ...
  [ "not doing too much these days", "these days i feel a lot more relaxed. sure the wife tells me i can't just lay around the house. but i feel like i earned it this time. even the lord rested after putting in some good work.", 8 ],
  [ "played some chess", "played a great game of chess. the whole game made a made a beautiful 4D pattern! can't understand why humans don't love logic. ", 9 ],
]
